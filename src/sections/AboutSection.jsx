...
const FEATURES = [
  {
    ...
    title: 'Vetted Chauffeur Network',
    desc: 'Background checked, professional transit handlers certified for interstate tracks.',
  },
  {
    icon: <Clock className="h-5 w-5" />,
    title: 'Real-time Live Dispatch',
    desc: 'Fleet units aligned with autonomous routing metrics for guaranteed prompt responses.',
  },
  {
    icon: <CheckCircle className="h-5 w-5" />,
    title: 'Zero Surge Contingency',
    desc: 'Flat per-kilometer balance standard preserved during peak meteorological intervals.',
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div variants={imageVariants} className="lg:col-span-7 relative h-64 sm:h-[420px] rounded-3xl overflow-hidden group">
          <img
          ...
          <div className="absolute bottom-4 left-4 right-4 sm:bottom-6 sm:left-6 sm:right-6 p-4 sm:p-6 glass-panel rounded-xl space-y-1">
            <span className="text-[10px] text-amber-500 font-bold uppercase tracking-widest">Executive Standard</span>
            <h4 className="text-sm sm:text-lg font-bold text-white uppercase tracking-wide">Detailed Mechanics & Sanitation</h4>
            <p className="text-[10px] sm:text-xs text-zinc-300">Every outstation module goes through meticulous multi-point functional verification.</p>
          </div>
        </motion.div>
      </motion.div>
    </section>
